...
This container image includes Node.JS 10 as a [S2I](https://github.com/kubesphere/s2ioperator) base image for your Node.JS 10 applications.
Users can choose between RHEL and CentOS based builder images.
The CentOS image is then available on [Docker Hub](https://hub.docker.com/r/kubespheredev/nodejs-10-centos8/)
as kubespheredev/nodejs-10-centos8. 
...
Usage
---------------------
To build a simple [nodejs-sample-app](https://github.com/kubesphere/s2i-nodejs-container/tree/master/10/test/test-app) application
using standalone [S2I](https://github.com/kubesphere/s2ioperator) and then run the
resulting image with [Docker](http://docker.io) execute:

*  **For RHEL based image**
    ```
    $ s2i build https://github.com/kubesphere/s2i-nodejs-container.git --context-dir=8/test/test-app/ rhel8/nodejs-10 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```

*  **For CentOS based image**
    ```
    $ s2i build https://github.com/kubesphere/s2i-nodejs-container.git --context-dir=8/test/test-app/ kubespheredev/nodejs-10-centos8 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```
...
See also
--------
Dockerfile and other sources are available on https://github.com/kubesphere/s2i-nodejs-container.
